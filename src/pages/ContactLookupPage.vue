  ...
  <q-page class="flex flex-center">
    ...
    <q-card flat>
      <q-card-section horizontal>
        ...
        <q-card-section class="q-pa-none" v-if="selectedContact">
              ...
              <q-card-section horizontal class="items-center bottom-border">
                <q-card-section class="items-center text-center">
                  <q-avatar rounded size="50px" color="primary">
                    <q-btn
                      v-if="!selectedContact.attributes.avatar"
                      flat
                      icon="add"
                      text-color="white"
                      class="add-avatar"
                  ...
                  <q-item-label v-if="!selectedContact.attributes.avatar"
                    >Photo</q-item-label
                  >
                </q-card-section>
                <q-card-section class="q-pl-none">
                  ...
                  <p v-else style="font-size: 18px">
                    {{ selectedContact.attributes.Name }}
                  </p>
                </q-card-section>
              </q-card-section>
              <q-card-section>
